    ...
    <section id="editor" className="relative scroll-mt-16">
      <Container>
        <div className="mx-auto max-w-2xl border-y border-ink/15 py-10 text-center">
          <p className="label-serif mb-4 text-ink-faint">Editor&rsquo;s note</p>
          <p className="font-body text-[1.05rem] leading-[1.7] text-ink-soft text-pretty">
          ...
          <p className="mt-4 font-body text-[0.95rem] text-ink-soft">
            Want it?{" "}
            <a
              href="#cta"
